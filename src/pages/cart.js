            ...
            <tbody>
                ${cart.length > 0 ? cart.map(item => /*html*/`
                    <tr>
                        ...
                        <td class="">
                            <a href="/products/${item.id}" class="flex text-black">
                                <img src="${item.image}"
                                class="w-20 rounded" alt="Thumbnail">
                                <div>
                                    <p class="mb-2 md:ml-4">${item.name}</p>
                                    <span class="mb-2 md:ml-4">${item.categoryProduct.name}</span>
              ...
              <div class="p-4">
                ...
                <form action="#" id="form-checkout">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="cart-name" id="cart-name" value="${localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')).username : ""}" autocomplete="given-name" class="h-10 mt-1 py-2 px-3 border border-gray-300  focus:ring-indigo-500 focus:border-[#0066B3] block w-full shadow-sm sm:text-sm  rounded-md" >
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                      <label for="first-name" class="block text-sm font-medium text-gray-700">Email:</label>
                      <input type="email" name="cart-email" id="cart-email" value="${localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')).email : ""}" autocomplete="given-name" class="h-10 mt-1 py-2 px-3 border border-gray-300  focus:ring-indigo-500 focus:border-[#0066B3] block w-full shadow-sm sm:text-sm  rounded-md" >
                  </div>
                  <div class="col-span-6 sm:col-span-3">
                      <label for="first-name" class="block text-sm font-medium text-gray-700">Số Điện Thoại:</label>
                      <input type="number" name="cart-phonenumber" id="cart-phonenumber" value="${localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')).phonenumber : ""}" autocomplete="given-name" class="h-10 mt-1 py-2 px-3 border border-gray-300  focus:ring-indigo-500 focus:border-[#0066B3] block w-full shadow-sm sm:text-sm  rounded-md" >
                  </div>
                  <div class="col-span-6 sm:col-span-6">
                      ...
                      <div class="mt-1">
                          <textarea id="cart-address" name="cart-address" rows="3" class="h-32 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"  >${localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user')).address : ""}</textarea>
                      </div>
                  </div>
            ...
            <div class="lg:px-2 lg:w-1/2">
              ...
              <div class="p-4">
                ...
                <div class="flex justify-between pt-4 border-b">
                  ...
                  <button  type="submit" form="form-checkout" id="payment"
