...
import { getAllCateProduct,remove } from "../../../api/cateProduct"
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                    <button class="btn btn-primary btn-add"><a href="/admin/categoryProducts/add" class="btn-link">Thêm Danh Mục Sản Phẩm</a></button>
                        ...
                        <tbody>
                          ...
                          ${data.map((category) =>/*html*/`
                            <tr>
                              ...
                              <th>${category.name}</th>
                              <th>
                                  <a href="/admin/categoryProducts/${category.id}/edit" >
                              ...
                              <th> 
                                <button type="submit" data-id="${category.id}" class="btn-delete inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-500 hover:bg-[#F26F1B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F26F1B]" >
